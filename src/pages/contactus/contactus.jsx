...
export const Contactus = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_rwl93go', 'template_89ccvg6', form.current, 'hcy8HfEYfLrOdGrDB')
            .then((result) => {
            }, (error) => {
  ...
  return (
    <>
      <section className="p-[9%] bg-white py-20 lg:py-[120px] overflow-hidden relative z-10">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-base leading-relaxed mb-9 text-body-color">
                  DR Group mund të ju ndihmoj, ekipi jonë është gjithëmon i gatëshem për ju, prandaj nese keni ndonjë pyetje rreth DR Group apo ndonjë gjë tjeter, 
                  ju lutem te na kontaktoni duke plotësuar formularin e më poshtëm
                </p>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              ...
              <form ref={form} onSubmit={sendEmail}>
                  ...
                  <ContactInputBox
                    type="text"
                    name="phone"
                    placeholder="Numëri i telefonit"
                  />
                  <ContactTextArea
                    row="6"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-black transition border rounded border-primary bg-primary hover:bg-opacity-90 hover:outline outline-offset-0 outline-1 outline-red-800 hover:text-red-800"
                      onClick={Alert}
                    >Dërgoni
                    </button>
                  </div>
